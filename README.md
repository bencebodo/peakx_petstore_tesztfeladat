...
Maven installed (MAVEN_HOME configured)
...
Bash
mvn clean test
(Optional) To view detailed HTTP network traffic in the console, enable DEBUG logging in your application.properties.
